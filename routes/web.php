...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::group(['middleware' => ['can:validasi'], 'prefix' => 'validasi', 'as' => 'validasi.'], function(){
    ...
    Route::group(['middleware' => ['can:lolos'], 'prefix' => 'lolos', 'as' => 'lolos.'], function(){
    ...
    Route::group(['middleware' => ['can:pembayaran'], 'prefix' => 'pembayaran', 'as' => 'pembayaran.'], function(){
    ...
    Route::group(['middleware' => ['can:rekom-internal', 'can:rekom-eksternal'], 'prefix' => 'rekomendasi', 'as' => 'rekomendasi.'], function(){
    ...
    Route::group(['middleware' => ['can:nim'], 'prefix' => 'nim', 'as' => 'nim.'], function(){
        Route::get('', [App\Http\Controllers\NimController::class, 'index'])->name('index');
    });

    Route::group(['middleware' => ['can:manajemen'], 'prefix' => 'prodi', 'as' => 'prodi.'], function(){
    ...
    Route::group(['middleware' => ['can:manajemen'], 'prefix' => 'pengguna', 'as' => 'pengguna.'], function(){
